...
void imported_videos(vector<string> &video_id, vector<string> &video_path, vector<string> &video_url);
...
//TVoctreeVLFeat VT;
/************************************************************************/
/*		edit "Video_info", "ES_params", "MYSQL_params" than execute	            */
/************************************************************************/
int main(int argc, char* argv[])
{
	...
	//myVideo_info->id			= ;
	myVideo_info->url			= "https://www.youtube.com/watch?v=UUta7HFc59k";
	myVideo_info->fileName		= "WindEnergy7Reviews.mp4";
	myVideo_info->newVideo		= false;
	myVideo_info->source_type	= "youtube";
	myVideo_info->encoding		= "mp4";

	TVoctreeVLFeat* VT = new TVoctreeVLFeat;

	initialization(VT,myPath);	
	/**
	//vector<string> sceneList,duration;
	//frame_extract(myVideo_info, myPath);
	//scene_extract(sceneList, duration, false, myPath, myVideo_info);
	//////	new video 
	//MYSQL_commit_video_meta(myMYSQL, myVideo_info);
	//for(int i = 0; i < sceneList.size(); i++){
	//	frame* f = new frame(myPath, sceneList[i], myVideo_info, i, atoi(duration[i].c_str()));
	//	f->feature_extract_and_quantize(VT, myPath);
	//	f->get_json4new_video(myVideo_info,myAlg,myPath);
	//	f->ES_commit(myES);
	//	f->MYSQL_commit(myMYSQL,myVideo_info,myAlg,myPath);
	//}
	**/
	//query video
	vector<string> sceneList,duration;
	frame_extract(myVideo_info, myPath);
	scene_extract(sceneList, duration, true, myPath, myVideo_info);
	vector<vector<string>> ES_results;
	for (int i = 0; i < sceneList.size(); i++){
		frame* f = new frame(myPath, sceneList[i], myVideo_info, i, atoi(duration[i].c_str()));
		f->feature_extract_and_quantize(VT, myPath);
		f->get_json4query();
		f->ES_post_query(myES, ES_results);
	}
	ofstream myfile;
	string CSV_Path = myVideo_info->fileName + ".csv";
...
void imported_videos(vector<string> &video_id, vector<string> &video_path, vector<string> &video_url)
{
	...
	string v_path[34] = {
		"906727dd-77af-4829-af55-34df64a50dd6_copy.mp4",
		"97eb6651-bbc7-4424-a92f-2649c4eebff3_copy.mp4",
		"87a227fd-d75a-466b-8c8a-98e8ecc6757e_copy.mp4",
		"4d4a4950-cbbb-4d8f-972a-b81c27b5bcd0_copy.mp4",
		"b9f2f9d6-2f3b-4e8a-be70-3298c72fecc7_copy.mp4",
		"197ec7e9-6a0b-4f2f-8900-3a92c7eee331_copy.mp4",
		"b69ce2a8-e3a2-4fdb-a0c6-cdebf7489975_copy.mp4",
		"a91048c5-8e2c-4327-9a51-9cdc08b43a66_copy.mp4",
		"742fd652-1de8-4008-9449-260a8c1b7716_copy.mp4",
		"8817c208-5ec2-4e82-95f9-111ad7066f0c_copy.mp4",
		"a1bca3be-f93e-4932-a646-ddf0895e10d0_copy.mp4",
		"fb8a922f-2a6a-4a6d-ae75-da4009c55656_copy.mp4",
		"a0edbcf7-9027-49f9-bca3-9ce828e27353_copy.mp4",
		"3b898df0-5dd9-4b69-8b08-643f1a412c84_copy.mp4",
		"e298ceed-3fec-4086-a416-05f909c3ed0d_copy.mp4",
